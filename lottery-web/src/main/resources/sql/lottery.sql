...
CREATE TABLE `lottery_dlt` (
  ...
  `prize_one_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_one_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_one_additional_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_one_additional_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_two_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_two_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_two_additional_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_two_additional_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_three_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_three_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_three_additional_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_three_additional_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_four_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_four_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_four_additional_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_four_additional_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_five_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_five_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_five_additional_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_five_additional_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_six_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_six_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_six_additional_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_six_additional_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_seven_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_seven_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_seven_additional_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_seven_additional_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_eight_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_eight_every_money` bigint(20) NOT NULL DEFAULT '0',
  `prize_eight_additional_num` bigint(20) NOT NULL DEFAULT '0',
  `prize_eight_additional_every_money` bigint(20) NOT NULL DEFAULT '0',
  `status` int(11) NOT NULL DEFAULT '1' COMMENT '状态：0 失效 1 有效',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `remark` varchar(2048) NOT NULL DEFAULT '',
